...
export const SET_CITY_DATA = 'cityData/SET_CITY_DATA';
...
export const setCityData = makeActionCreator(SET_CITY_DATA, 'cityData')
export const setHasStarted = makeActionCreator(SET_HAS_STARTED, 'bool');
